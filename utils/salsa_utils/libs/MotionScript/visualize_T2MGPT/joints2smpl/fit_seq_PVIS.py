...
parser.add_argument('--files', type=str, default="test_motion2.npy",
                    help='files use')
...
for idx in range(num_seqs):
    ...
    mesh_p = trimesh.Trimesh(vertices=outputp.vertices.detach().cpu().numpy().squeeze(), faces=smplmodel.faces,
                             process=False)
