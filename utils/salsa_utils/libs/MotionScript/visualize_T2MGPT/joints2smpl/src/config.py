...
SMPL_MODEL_DIR = "..\\visualize_T2MGPT\\body_models/"
GMM_MODEL_DIR = "..\\visualize_T2MGPT\\joints2smpl\\smpl_models\\"
SMPL_MEAN_FILE = "..\\visualize_T2MGPT\\joints2smpl\\smpl_models\\neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "..\\visualize_T2MGPT\\joints2smpl\\smpl_models\\smplx_parts_segm.pkl"

# Grabbed from the original repo instead of T2M-GPTF
...
GMM_MODEL_DIR = rt_path + "smpl_models\\" # "./smpl_models/"
SMPL_MEAN_FILE = rt_path + "smpl_models\\neutral_smpl_mean_params.h5" # "./smpl_models/neutral_smpl_mean_params.h5"
# for collsion
Part_Seg_DIR = rt_path + "smpl_models\\smplx_parts_segm.pkl" # "./smpl_models/smplx_parts_segm.pkl"