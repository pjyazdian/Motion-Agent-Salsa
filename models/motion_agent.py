...
class MotionAgent:
    def __init__(self, args, client):
        ...
        self.model.load_model('output_trained/Second trial/Xmotionllm_epoch25.pth') # ('ckpt/motionllm.pth')
        self.model.eval()
        ...
        prompt = open("example_prompt_direct_test.txt", "r", encoding='utf-8').read() # loading the example prompt, feel free to use your own prompt
